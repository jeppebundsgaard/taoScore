...
namespace dpu\taoScore\model\theme;
...
/**
 * Class TaoscoreDefaultTheme
 *
 * @package dpu\taoScore\model\theme
 */
class TaoscoreDefaultTheme extends DefaultTheme
{

    /**
     * Id of this extension
     */
    const EXTENSION_ID = 'taoScore';


    /**
     * Theme's label
     */
    const THEME_LABEL = 'taoScore default theme';


    /**
     * Theme's id, by default label without spec chars
     */
    const THEME_ID = 'taoscoreDefaultTheme';
